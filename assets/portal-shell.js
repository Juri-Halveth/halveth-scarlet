(function(){
  ...
  const routes=[
    ...
    {id:'debbi',path:'forschung/de-debbi-hela/',index:'15',image:'scarlet',accent:'#ff6d9f',de:'DE → DEBBI',en:'DE → DEBBI',deNote:'Erst A beantworten, dann Multiversum',enNote:'Answer A first, then the multiverse'}
  ];
