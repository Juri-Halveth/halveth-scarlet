(function(){
  ...
  const routes=[
    ...
    {id:'team',path:'./#team',index:'08',image:'nexus',accent:'#ff7ac8',de:'Die Konstellation',en:'The constellation',deNote:'68 öffentliche Karten: Perspektiven, Figuren, Projekte und Quellen',enNote:'68 public cards: perspectives, characters, projects and sources'},
  ...
  const render=()=>{
    ...
    map.querySelector('h2').textContent=english?'Eleven portals. One constellation.':'Elf Portale. Eine Konstellation.';
